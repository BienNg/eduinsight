...
jest.mock('../firebaseService', () => {
  return {
    getNextGroupColor: jest.fn(() => Promise.resolve('#911DD2')),
    getOrCreateGroupRecord: jest.fn(() => Promise.resolve({
      id: 'group1',
      name: 'G1',
      courseIds: [],
      color: '#911DD2',
    ...
    normalizeTeacherName: jest.requireActual('../firebaseService').normalizeTeacherName,
    createTeacherRecord: jest.fn(() => Promise.resolve({
      id: 'teacher1',
      name: 'Test Teacher',
      courseIds: []
    })),
    createOrUpdateStudentRecord: jest.fn(() => Promise.resolve({
      id: 'student1',
      name: 'Test Student',
      courseIds: ['course1']
    })),
    getOrCreateMonthRecord: jest.fn(() => Promise.resolve({
      id: '2025-01',
      name: 'January 2025',
      sessionCount: 0,
      courseIds: []
    })),
    findExistingCourse: jest.fn(() => Promise.resolve(null))
  };
});
